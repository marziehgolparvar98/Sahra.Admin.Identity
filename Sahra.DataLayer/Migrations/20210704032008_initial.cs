        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartUpEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Mobile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TeamPersonCount = table.Column<int>(type: "int", nullable: false),
                    ...
                    HasProductIdea = table.Column<bool>(type: "bit", nullable: false),
                    IsActiveUser = table.Column<bool>(type: "bit", nullable: false),
                    Need = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Invest = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestStatus = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvestRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RelationOfInvestReqs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvestRequestId = table.Column<int>(type: "int", nullable: false),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnumCategory = table.Column<int>(type: "int", nullable: true),
                    EnumCollaboration = table.Column<int>(type: "int", nullable: true),
                    EnumPlatform = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelationOfInvestReqs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelationOfInvestReqs_InvestRequests_InvestRequestId",
                        column: x => x.InvestRequestId,
                        principalTable: "InvestRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsCreator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NewsCategoryId = table.Column<int>(type: "int", nullable: false),
                    NewsSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatNews = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SlideAlt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelationOfInvestReqs_InvestRequestId",
                table: "RelationOfInvestReqs",
                column: "InvestRequestId");
