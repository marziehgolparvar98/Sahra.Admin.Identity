...
using Sahra.STS.Identity.Configuration;
using Sahra.STS.Identity.Configuration.ApplicationParts;
using Sahra.STS.Identity.Configuration.Constants;
using Sahra.STS.Identity.Configuration.Interfaces;
using Sahra.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Sahra.STS.Identity.Helpers
{
